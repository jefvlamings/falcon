...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Post.from_person'
        db.delete_column(u'fb_post', 'from_person_id')

        # Adding field 'Post.person'
        db.add_column(u'fb_post', 'person',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['fb.Person']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Post.from_person'
        db.add_column(u'fb_post', 'from_person',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['fb.Person']),
                      keep_default=False)

        # Deleting field 'Post.person'
        db.delete_column(u'fb_post', 'person_id')
