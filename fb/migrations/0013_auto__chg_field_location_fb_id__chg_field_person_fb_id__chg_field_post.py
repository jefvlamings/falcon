...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Post.picture'
        db.alter_column(u'fb_post', 'picture', self.gf('django.db.models.fields.TextField')(null=True))
        ...
        db.alter_column(u'fb_post', 'link', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'Location.fb_id'
        db.alter_column(u'fb_location', 'fb_id', self.gf('django.db.models.fields.CharField')(max_length=30, null=True))

        # Changing field 'Person.fb_id'
        db.alter_column(u'fb_person', 'fb_id', self.gf('django.db.models.fields.CharField')(max_length=30, null=True))

        # Changing field 'Post.picture'
        db.alter_column(u'fb_post', 'picture', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'Post.fb_id'
        db.alter_column(u'fb_post', 'fb_id', self.gf('django.db.models.fields.CharField')(max_length=30, null=True))

        # Changing field 'Post.link'
        db.alter_column(u'fb_post', 'link', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))
    ...
    models = {
        u'fb.location': {
            ...
            'fb_id': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
