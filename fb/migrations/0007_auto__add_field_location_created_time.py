...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Location.created_time'
        db.add_column(u'fb_location', 'created_time',
                      self.gf('django.db.models.fields.TimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Location.created_time'
        db.delete_column(u'fb_location', 'created_time')
    ...
    models = {
        u'fb.location': {
            ...
            'created_time': ('django.db.models.fields.TimeField', [], {'null': 'True', 'blank': 'True'}),
