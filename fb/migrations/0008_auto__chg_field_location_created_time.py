...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Location.created_time'
        db.alter_column(u'fb_location', 'created_time', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # Changing field 'Location.created_time'
        db.alter_column(u'fb_location', 'created_time', self.gf('django.db.models.fields.TimeField')(null=True))
