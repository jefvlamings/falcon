...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'fb_location', 'fb_id', self.gf('django.db.models.fields.IntegerField')(max_length=30, null=True))
        # Adding field 'Relationship.mutual_friends'
        db.add_column(u'fb_relationship', 'mutual_friends',
                      self.gf('django.db.models.fields.IntegerField')(max_length=30, null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Relationship.mutual_friends'
        db.delete_column(u'fb_relationship', 'mutual_friends')
    ...
    models = {
        u'fb.location': {
            ...
            'fb_id': ('django.db.models.fields.IntegerField', [], {'max_length': '30', 'null': 'True', 'blank': 'True'}),
        ...
        u'fb.person': {
            ...
            'relationships': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['fb.Person']", 'through': u"orm['fb.Relationship']", 'symmetrical': 'False'}),
        ...
        u'fb.relationship': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'mutual_friends': ('django.db.models.fields.IntegerField', [], {'max_length': '30', 'null': 'True', 'blank': 'True'}),
