...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal(u'fb', ['Progress'])

        # Deleting field 'Person.progress'
        db.delete_column(u'fb_person', 'progress')


    def backwards(self, orm):
        # Deleting model 'Progress'
        db.delete_table(u'fb_progress')

        # Adding field 'Person.progress'
        db.add_column(u'fb_person', 'progress',
