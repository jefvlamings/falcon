...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Relationship.mutual_friend_count'
        db.add_column(u'fb_relationship', 'mutual_friend_count',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Relationship.mutual_friend_count'
        db.delete_column(u'fb_relationship', 'mutual_friend_count')
